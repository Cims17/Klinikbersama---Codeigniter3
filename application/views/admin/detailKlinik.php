				...
				<div class="page-title-box">
					<div class="row">
						<div class="col">
							...
							<ol class="breadcrumb">
								<li class="breadcrumb-item">Data Klinik</li>
						...
						<div class="row">
							<div class="col-lg-6 col-xl-6">
								<div class="card">
									...
									<!--end card-header-->
									<form action="<?= base_url() ?>Admin/Data_klinik/Updateprofil_klinik/<?= $klinik->id_klinik ?>" method="post" enctype="multipart/form-data">
										<div class="card-body">
											<div class="form-group row">
						...
						<div class="row">
							<div class="col-lg-12 col-xl-12">
								<div class="card">
									...
									<!--end card-header-->
									<form action="<?= base_url() ?>Admin/Data_klinik/Updatepeta_klinik/<?= $klinik->id_klinik ?>" method="post" enctype="multipart/form-data">
										<div class="card-body">
											<div class="form-group row">
