        ...
        <div id="bootcarousel" class="carousel text-large slide carousel-fade animate_text" data-ride="carousel">
            ...
            <div class="carousel-inner carousel-zoom">
                <div class="carousel-item active">
                    <div class="slider-thumb bg-cover" style="background-image: url(assets/user/img/2440x1578.png);"></div>
                    <div class="box-table">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="testimonials-carousel text-center owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="provider">
                                <div class="thumb">
                                    <img src="<?= base_url() ?>assets/user/img/100x100.png" alt="Thumb">
                                </div>
                                <div class="bio">
                                    <h5>Jonathom Doe</h5>
        ...
        <div class="container">
            <div class="contact-items">
                <div class="row">
                    ...
                    <div class="col-lg-7 wow address-box fadeInUp bg-cover" style="background-image: url(assets/user/img/2440x1578.png);">
                    ...
                    <div class="col-lg-5 wow fadeInLeft contact-form-box">
                        ...
                        <form action="<?= base_url() ?>assets/user/mail/contact.php" method="POST" class="contact-form">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
